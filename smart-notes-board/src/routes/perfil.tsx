...
export const Route = createFileRoute("/perfil")({
  head: () => ({
    meta: [
      { title: "Perfil - Goodnotes" },
      {
        name: "description",
        content: "Edite seu nome, e-mail, cargo, foto e informações da conta no Goodnotes.",
      },
      { property: "og:title", content: "Perfil - Goodnotes" },
      {
        property: "og:description",
        content: "Gerencie os dados e a foto da sua conta no Goodnotes.",
      },
