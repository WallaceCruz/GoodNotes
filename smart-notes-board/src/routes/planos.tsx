...
export const Route = createFileRoute("/planos")({
  head: () => ({
    meta: [
      { title: "Planos - Goodnotes" },
      {
        name: "description",
        content:
          "Compare os planos Free, Pro e Team do Goodnotes e escolha o ideal para o seu fluxo de notas.",
      },
      { property: "og:title", content: "Planos - Goodnotes" },
      {
