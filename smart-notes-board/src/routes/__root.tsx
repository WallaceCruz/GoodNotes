...
import { startBoardEffects } from "@/stores/board-effects";
...
function RootComponent() {
  ...
  // Gravação e automações do quadro valem em qualquer rota, não só no quadro:
  // renomear um projeto pelas configurações também precisa ser salvo.
  useEffect(() => {
    startBoardEffects();
  }, []);
