...
export const Route = createFileRoute("/configuracoes")({
  head: () => ({
    meta: [
      { title: "Configurações - Goodnotes" },
      {
        name: "description",
        content:
          "Ajuste lembretes de prazo, notificações e preferências do seu quadro de notas no Goodnotes.",
      },
      { property: "og:title", content: "Configurações - Goodnotes" },
      {
        property: "og:description",
        content: "Preferências de notificações e lembretes do Goodnotes.",
      },
